...
/*#define KIFU_RATIO    ( 48566 / (double)KIFU_RECORDS )  // =1.8971 =n‚Æ‚·‚éB2(n^2)*ãn=9.914    */
// FV_PENALTY=0.2/(2*n^2*ãn)/32 (SEARCH_DEPTH=1)
#define FV_WINDOW               288     // (default=256)SEARCH_DEPTH=1‚ÌŽž320,2‚ÌŽž304,3‚ÌŽž288  ŠwKŠû•ˆdepth8‚ÌŽž240,depth9Šû•ˆ‚ÌŽž256
#define FV_SCALE                32     // FV_PENALTY‚ÍASEARCH_DEPTH=2‚ÌŽž ã2,SEARCH_DEPTH=3‚ÌŽž 2(=ã4)‚ðŠ|‚¯‚éB
#define FV_PENALTY             ( 0.02 / (double)FV_SCALE ) // 0.2/( 2*(1.8971^2)*ã1.8971 ) (default=0.2)
...
extern unsigned int sec_limit;     //Ž‚¿ŽžŠÔ
extern unsigned int sec_limit_up;  //•b“Ç‚ÝŽžŠÔ
extern unsigned int sec_limit_depth;
extern unsigned int sec_elapsed;   //Á”ïŽžŠÔ
extern unsigned int sec_b_total;   //æŽè‚ÌÁ”ïŽžŠÔ
extern unsigned int sec_w_total;   //ŒãŽè‚ÌÁ”ïŽžŠÔ
extern unsigned int btime;         //æŽè‚ÌŽc‚èŽžŠÔ
extern unsigned int wtime;         //ŒãŽè‚ÌŽc‚èŽžŠÔ
extern unsigned int binc;          //æŽè‚Ì‰ÁŽZŽžŠÔ
extern unsigned int winc;          //ŒãŽè‚Ì‰ÁŽZŽžŠÔ
