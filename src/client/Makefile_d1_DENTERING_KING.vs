...
FLAG = /DNDEBUG /DTLP /DHAVE_SSE4 /DCSA_LAN /DMNJ_LAN /DENTERING_KING /DLEARN_EKING 
...
cl:
	$(MAKE) -f Makefile_d1_DENTERING_KING.vs bonanza.exe CC="cl" LD="link"\
		CFLAGS="$(FLAG) /MT /W4 /nologo /O2 /Ob2 /GS- /GL"\
		LDFLAGS="/NOLOGO /out:bonanza.exe /LTCG"

cl-pgo:
	$(MAKE) -f Makefile_d1_DENTERING_KING.vs clean
	$(MAKE) -f Makefile_d1_DENTERING_KING.vs bonanza.exe CC="cl" LD="link"\
		CFLAGS="$(FLAG) /MT /W4 /nologo /O2 /Ob2 /GS- /GL"\
		LDFLAGS="/NOLOGO /out:bonanza.exe /LTCG:PGI"
	$(MAKE) -f Makefile_d1_DENTERING_KING.vs pgo-run
	del bonanza.exe
	$(MAKE) -f Makefile_d1_DENTERING_KING.vs bonanza.exe LD="link"\
		LDFLAGS="/NOLOGO /out:bonanza.exe /LTCG:PGO"

icl:
	$(MAKE) -f Makefile_d1_DENTERING_KING.vs bonanza.exe CC="icl" LD="icl"\
...
pgo-run:
	echo learn no-ini 34 -1 25 4 4  >> runprof
